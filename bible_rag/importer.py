...
UNIT_SOURCES = {
    ...
    "Offices":     "office",
    "Lexemes":     "lexeme",
    # Taxonomy v2: literary devices, rhetorical, narrative, hermeneutic, liturgical
    "Chiasms":                 "chiasm",
    "Inclusios":               "inclusio",
    ...
    "Woes":                    "woe",
    "Blessings":               "blessing-form",
    "Curses":                  "curse-form",
    "Enigmas":                 "enigma",
    "Dreams":                  "dream",
    "Visions":                 "vision",
    "Genealogies":             "genealogy",
    "Naming-Etiologies":       "naming-etiology",
    "Call-Narratives":         "call-narrative",
    "Typological-Fulfillments": "typological-fulfillment",
    "Antitypes":               "antitype",
    "Recapitulations":         "recapitulation",
    "Reversals":               "reversal",
    "Anti-Parallels":          "anti-parallel",
    "Anti-Motifs":             "anti-motif",
    "Psalm-Types":             "psalm-type",
    "Songs":                   "song",
    "Prayer-Formulas":         "prayer-formula",
    "Hymns":                   "hymn",
}
